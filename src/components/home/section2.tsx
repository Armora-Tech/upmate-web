...
export function Section2() {
  ...
  return (
    <div className="pb-12 min-w-full flex flex-col bg-textBlack align-center items-center">
      ...
      <div data-aos="fade-up" data-aos-duration="2300" className="w-full h-full flex flex-row md:px-10 px-5">
        <Swiper
          spaceBetween={10}
          slidesPerView={1}
          effect={"coverflow"}
...
//  style={{borderTopRightRadius: "100px", borderTopLeftRadius: "100px"}}
